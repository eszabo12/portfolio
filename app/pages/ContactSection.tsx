					...
					<div className="relative z-10">
						...
						<div className="font-mono">
							...
							<motion.a
								...
								className="inline-flex items-center gap-2 px-6 py-3 bg-white text-green-600 rounded-2xl border border-green-500/30 hover:border-green-500 hover:border-2 transition-all duration-200 cursor-pointer mb-2"
							>
							...
							<motion.a
								...
								className="inline-block px-6 py-3 bg-white text-green-600 rounded-xl border border-green-500/30 hover:border-green-500 hover:border-2 transition-all duration-200"
							>
							...
							<motion.a
								...
								className="inline-flex items-center gap-2 px-6 py-3 bg-white text-green-600 rounded-xl border border-green-500/30 hover:border-green-500 hover:border-2 transition-all duration-200 cursor-pointer"
								tabIndex={0}
								role="button"
								onKeyDown={e => {
							...
							<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
								<motion.a
									...
									className="inline-flex items-center gap-3 px-6 py-3 bg-white text-green-600 rounded-xl border border-green-500/30 hover:border-green-500 hover:border-2 transition-all duration-200 cursor-pointer"
								>
