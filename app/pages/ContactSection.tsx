					...
					<div className="relative z-10">
						...
						<div className="font-mono">
							...
							<motion.a
								...
								className="inline-flex items-center gap-2 px-6 py-3 bg-white text-green-600 rounded-2xl border border-green-500/30 hover:bg-green-50 hover:border-green-500 transition-all duration-300 cursor-pointer mb-2"
							>
							...
							<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
								<motion.a
									...
									whileHover={{ scale: 1.02 }}
									className="inline-flex items-center gap-3 px-6 py-3 bg-green-500/10 text-green-400 rounded-xl border border-green-500/20 hover:bg-green-500/20 hover:border-green-400 transition-all duration-300 cursor-pointer"
								>
