		...
		<section className="py-20 px-4">
			<div className="max-w-6xl mx-auto">
				...
				<div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
					...
					>
						<div className="relative p-6 rounded-2xl overflow-hidden backdrop-blur-lg border border-gray-800 bg-black/50 hover:border-green-400 transition-all duration-300 w-full h-full flex flex-col items-center justify-center">
					...
					<div className="flex flex-col">
						...
						>
							<div className="relative p-6 rounded-2xl overflow-hidden backdrop-blur-lg border border-gray-800 bg-black/50 hover:border-green-400 transition-all duration-300 h-full flex flex-col justify-center">
								<div className="absolute inset-0 bg-gradient-to-r from-green-500/5 to-blue-500/5" />
