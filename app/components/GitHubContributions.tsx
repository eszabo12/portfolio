...
export default function GitHubContributions() {
	...
	return (
		<motion.div
			className="w-full max-w-[38rem] bg-black rounded-[25px] flex flex-col justify-center mx-auto p-4 border-2 border-gray-900 mt-6"
		...
		>
			<div className="flex items-center mb-2">
				...
				<span className="text-white font-mono text-sm opacity-80">eszabo12</span>
			</div>
