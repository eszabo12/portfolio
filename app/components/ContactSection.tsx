					...
					<div className="relative z-10">
						...
						<div className="font-mono">
							...
							<motion.a
								...
								whileHover={{ scale: 1.02 }}
								className="inline-block px-6 py-3 bg-pink-500/10 text-pink-400 rounded-lg border border-pink-500/20 hover:bg-pink-500/20 transition-colors"
							>
							...
							<motion.a
								...
								whileHover={{ scale: 1.02 }}
								className="inline-flex items-center gap-2 px-6 py-3 bg-pink-500/10 text-pink-400 rounded-lg border border-pink-500/20 hover:bg-pink-500/20 transition-colors cursor-pointer"
								tabIndex={0}
								role="button"
								onKeyDown={e => {
							...
							<motion.p className="text-pink-500 mt-8 mb-4"
								initial={{ opacity: 0 }}
								animate={{ opacity: [0, 1, 0.7, 1] }}
